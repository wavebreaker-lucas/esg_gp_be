...
def send_email_to_user(email, password):
    ...
    text_message = (
        ...
        f"You can log in here: {settings.FRONTEND_URL}/login\n\n"
        ...
        f"电子邮件：{email}\n"
        f"临时密码：{password}\n\n"
        f"您可以由此登錄：{settings.FRONTEND_URL}/login\n\n"
    ...
    html_message = (
        ...
        f"</ul>"
        f"<p>You can log in here: <a href='{settings.FRONTEND_URL}/login'>{settings.FRONTEND_URL}/login</a></p>"
        ...
        f"</ul>"
        f"<p>您可以由此登錄：<a href='{settings.FRONTEND_URL}/login'>{settings.FRONTEND_URL}/login</a></p>"
