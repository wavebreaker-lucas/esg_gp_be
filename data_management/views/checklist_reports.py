...
def _generate_combined_report(submission_ids, regenerate=False, user=None):
    ...
    try:
        ...
        combined_prompt = (
            ...
            "   Strengths:\n"
            "   • [First strength bullet]\n"
            "   • [Second strength bullet]\n"
            "   • [Third strength bullet]\n\n"
            "   Weaknesses:\n"
            "   • [First weakness bullet]\n"
            "   • [Second weakness bullet]\n"
            "   • [Third weakness bullet]\n\n"
            "   And follow the same format for SOCIAL and GOVERNANCE sections.\n\n"
