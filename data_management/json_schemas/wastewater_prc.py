"""
Schema for PRC wastewater consumption.
Used for KPI A2.2 reporting.
"""

WASTEWATER_PRC_SCHEMA = {
    "type": "wastewater_prc",
    ...
    "template": {
        ...
        "properties": {
            "periods": {
                "type": "array",
                "description": "Monthly wastewater consumption values",
                "default": [
                ...
                "items": {
                    ...
                    "properties": {
                        ...
                        "value": {
                            ...
                            "nullable": True,
                            "minimum": 0,
                            "description": "Wastewater consumption value"
                        },
                        "unit": {
                            "type": "string", 
                            "enum": ["m³"],
            ...
            "total_consumption": {
                ...
                "properties": {
                    "value": {
                        "type": "number",
                        "readOnly": True,
                        "description": "Total wastewater consumption"
                    },
                    "unit": {
                        "type": "string", 
                        "enum": ["m³"],
