"""
Schema for Hong Kong HKE electricity consumption tracking.
Used for KPI A1.2 and A2.1 reporting.
"""

ELECTRICITY_HK_HKE_SCHEMA = {
    "type": "electricity_hk_hke",
    "name": "Hong Kong HKE Electricity Consumption",
    "description": "For tracking HKE electricity consumption in Hong Kong",
