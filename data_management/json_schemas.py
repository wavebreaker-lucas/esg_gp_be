"""
JSON schemas for the ESG Platform metrics.
...
NOTE: These are the actual schemas that will be used directly by the system,
not just examples. Each schema defines the exact JSON structure that will be 
stored in the database for the corresponding metric type.
"""
