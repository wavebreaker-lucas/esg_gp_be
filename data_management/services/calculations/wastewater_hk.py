...
class WastewaterHKCalculationHandler:
    """Calculation handler for Hong Kong wastewater data."""
...
wastewater_hk_handler = WastewaterHKCalculationHandler()
...
def calculate_wastewater_hk(data):
    ...
    """
    return wastewater_hk_handler.calculate(data)
